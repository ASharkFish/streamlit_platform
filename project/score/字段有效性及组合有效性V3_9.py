...
def main(customer):
    ...
    select_kehu1=df1[df1['客户品类']==customer].reset_index(drop=True)
    select_kehu2=df2[df2['客户品类']==customer].reset_index(drop=True)
    select_kehu3=df3[df3['客户品类']==customer].reset_index(drop=True)
    ...
    return list1,df_wrong,df_wrong1
